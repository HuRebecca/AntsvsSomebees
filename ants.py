    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 11
                assert self.ant.can_contain(insect) or insect.can_contain(self.ant),\
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                ...
                elif hasattr(self.ant, 'real_queen') and self.ant.real_queen:
                    return
                else:
                    self.ant = None
            else:
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    if hasattr(self.ant.ant, 'real_queen'):
                        if self.ant.ant.real_queen:
                            return
                        else:
                            self.ant.ant = None
                    else: self.ant.ant = None
                else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        place = self.place
        distance = 0
        while near_bee == None and place != hive:
...
# The WallAnt class
class WallAnt(Ant):
    ''' An Ant that does nothing each turn, has a large armor value'''
    name = 'Wall'
    food_cost = 4
    implemented = True
    ...
    def action(self, colony):
        ...
        if self.real_queen == False:
            ...
            while current_place is not None:
                a_ant = current_place.ant
                if a_ant != None:
                    if hasattr(a_ant, 'container') and a_ant.container and a_ant.ant != None:
                        if a_ant.ant not in self.ants_doubled:
                            a_ant.ant.damage *= 2
                            self.ants_doubled.append(a_ant.ant)
                    else:
                        if a_ant not in self.ants_doubled:
                            a_ant.damage *= 2
                            self.ants_doubled.append(a_ant)
